...
#define EEICA1_M24M01_WC2_PORT             GPIOA
#define EEICA1_M24M01_WC2_PIN              GPIO_PIN_2
#define EEICA1_M24M01_WC2_RCC              __HAL_RCC_GPIOA_CLK_ENABLE

#define EEICA1_NUCLEO_LED_PORT             GPIOA
#define EEICA1_NUCLEO_LED_PIN              GPIO_PIN_0
