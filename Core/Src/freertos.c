...
osThreadId_t ThreadRootHandle;
const osThreadAttr_t ThreadRoot_attributes = {
  .name = "ThreadRoot",
  .stack_size = 128 * 4,
...
/* USER CODE BEGIN Header_RootThread */
/**
  * @brief  Function implementing the ThreadRoot thread.
